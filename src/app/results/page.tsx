    ...
    <form onSubmit={handleTextSearch}>
      <div
        ...
        style={{
          ...
          transition:
            "box-shadow 0.25s ease, transform 0.35s cubic-bezier(0.19,1,0.22,1)",
        }}
      >
        {/* Search icon */}
        <Search
        ...
        <button
          ...
          style={{
            background:
              loading || inputFocused ? "#C4A882" : "rgba(255,255,255,0.10)",
            boxShadow:
              loading || inputFocused
                ? "0 4px 14px rgba(196,168,130,0.45)"
                : "none",
      ...
      >
        <div
          ...
          style={{
            width: "42%",
            background:
              "linear-gradient(90deg, transparent, #C4A882 40%, #E8C99A 60%, transparent)",
            ...
            {TRENDING.map((item, i) => (
              <motion.button
                ...
                onMouseDown={() => {
                  ...
                  setQuery(item.query);
                  router.replace(
                    `/results?q=${encodeURIComponent(item.query)}`,
                    { scroll: false },
                  );
                }}
    ...
    <div style={{ minHeight: "100dvh", background: "#F2EDE4" }}>
      ...
      {hasResults && (
        <>
            ...
            >
              {(["Women", "Men"] as Gender[]).map((g) => (
                <button
                  key={g}
                  onClick={() =>
                    g === "Men" ? showComingSoon() : setGender(g)
                  }
                  ...
                  style={{
                    ...
                    boxShadow:
                      gender === g ? "0 2px 6px rgba(0,0,0,0.2)" : "none",
                  }}
                >
                  {g}
                </button>
                  ...
                  {sort === opt.id && (
                    <motion.div
                      ...
                      style={{
                        background: "#1A1A1A",
                        boxShadow:
                          "0 0 0 2px rgba(196,168,130,0.40), 0 4px 14px rgba(0,0,0,0.18)",
                      }}
                      transition={{
                        type: "spring",
                        stiffness: 500,
          ...
          {activeFilterCount > 0 && (
            <div
              className="px-4 py-1.5 flex gap-1.5 flex-wrap"
                  ...
                  {quickViewProduct.imageUrl ? (
                    ...
                    <div
                      style={{
                        ...
                        justifyContent: "center",
                        background:
                          "linear-gradient(145deg, #EDE8E0 0%, #DDD5C6 100%)",
                      }}
                    >
                      <Zap
                        size={60}
                        style={{ color: "#9B8877", opacity: 0.4 }}
                      />
                    </div>
                  )}
                  ...
                  <button
                    onClick={() => {
                      localStorage.setItem(
                        `browseai:product:${quickViewProduct.id}`,
    ...
    <Suspense
      fallback={
        <div
          ...
          style={{ height: "100dvh", background: "#F2EDE4" }}
        >
          <div className="flex gap-1.5">
            {[0, 1, 2].map((i) => (
              <span
